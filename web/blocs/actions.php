            ...
            <form method="post" action="index.php" class="form-horizontal form-label-left switch-state">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="value_ca" class="date-picker form-control col-md-7 col-xs-12" required="required"
                               type="text">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="value_kh" class="date-picker form-control col-md-7 col-xs-12" required="required"
                               type="text">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9">
                        <input name="value_mg" class="date-picker form-control col-md-7 col-xs-12" required="required"
                               type="text">
                    </div>
                </div>
                <div class="form-group">
