<div class="col-md-6 col-xs-12 col-sm-12">
    <div class="x_panel">
        ...
        <div class="x_content progress-content">
            ...
            <p>Test Ca <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            ...
            <?php $numberMax = getConfig($link, 'check_analyse_eau'); ?>
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Test Mg <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-warning"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
            ...
            <?php $numberMax = getConfig($link, 'check_analyse_eau'); ?>
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Test Kh <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-warning"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
            ...
            <?php $numberMax = getConfig($link, 'check_analyse_eau'); ?>
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Test densité <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-warning"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
            ...
            <?php $numberMax = getConfig($link, 'check_analyse_eau'); ?>
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Test nitrate <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-warning"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
            ...
            <?php $numberMax = getConfig($link, 'check_analyse_eau'); ?>
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Test phosphate <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-warning"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
            ...
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Changement d'eau <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
            ...
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Nettoyage réacteur <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
            ...
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Nettoyage écumeur <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-success"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
            ...
            <?php $transitiongoal = getTransitiongoal($numberNow, $numberMax) ?>
            <p>Nettoyages pompes <small>(<?= $numberNow; ?>/<?= $numberMax; ?>J)</small></p>
            <div class="progress active">
                <div class="progress-bar progress-bar-striped progress-bar-success"
                     role="progressbar"
                     data-transitiongoal="<?= $transitiongoal; ?>">
